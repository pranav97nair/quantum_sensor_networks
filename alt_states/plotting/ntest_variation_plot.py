...
ghz_filename = f"data/ntest_variation_ghz_{postfix}.txt"
plus_filename = f"data/ntest_variation_plus_{postfix}.txt"
bell_filename = f"data/ntest_variation_bell_{postfix}.txt"
...
plt.savefig(f'figures/state_comparison_vs_ntest_{postfix}.png')
