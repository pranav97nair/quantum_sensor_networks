...
if __name__ == '__main__':
    ...
    LogManager.log_to_file(f"{pwd}/logs/running_estimation.log")
    ...
    data_dir = f"{pwd}/data/t{threshold_postfix}/{num_iters}_iters"
    sim_num = len(os.listdir(data_dir)) + 1
    filename = f"{data_dir}/sim{sim_num}_{network}.txt"
    ...
    print(f"Finished job t{threshold_postfix}_{num_iters}_iters.sh")
