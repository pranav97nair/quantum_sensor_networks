...
fig.tight_layout()
fig.savefig("figures/running_estimation_MSE_optim_highfid_x1000.png") """
...
ax1.set_title(f"Noisy parameter estimation (n={num_nodes}, ntest={ntest})\nOptimistic, high-fidelity parameters")
fig.tight_layout()
fig.savefig("figures/running_estimation_bias_optim_highfid_x1000.png")
