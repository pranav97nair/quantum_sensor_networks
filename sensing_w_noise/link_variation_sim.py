...
if __name__ == "__main__":
    ...
    psuccess_list = np.linspace(starting_psuccess, 1.0, datapoints)
    tcycle_list = np.linspace(starting_tcycle, perfect_tcycle, datapoints)
    ...
    filename = "data/failure_rate_vs_link_fidelity_optim_x50_(3).txt"
