...
if __name__ == '__main__':
    ...
    seed = int(sys.argv[2]) # number for random seeding phases
    ...
    if version > 1:
        filename = f"{pwd}data/estimation_seeded_x1000_{params}_{version}.txt"
    else:
        filename = f"{pwd}data/estimation_seeded_x1000_{params}.txt"
