...
class AliceProgram(Program):
    ...
    def run(self, context: ProgramContext):
        ...
        b_measurements = yield from csocket.recv()
        #print(f"Alice received measurements from Bob: \n{b_measurements}")
...
class BobProgram(Program):
    ...
    def run(self, context: ProgramContext):
        ...
        measurements = [int(r) for r in measurements]
        print(f"Bob's measurements: {measurements}")
        csocket.send(measurements)
        #print("Bob sent measurements to Alice")
